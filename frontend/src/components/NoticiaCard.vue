    ...
    <div class="flex items-start gap-3 mb-3">
      ...
      <div class="flex-1 min-w-0">
        <div class="flex items-start justify-between gap-2">
          <div class="min-w-0">
            <h3 class="font-bold text-base md:text-lg group-hover:text-orange-600 transition-colors break-words">
              {{ noticia.titulo_pt || noticia.titulo }}
            </h3>
            <p v-if="noticia.titulo_pt && noticia.titulo && noticia.titulo_pt !== noticia.titulo"
